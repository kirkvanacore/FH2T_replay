...
# model evaluation
auc(ad$any_replay, predict(RQ1_2_mod2, ad))
...
# adjusted values for the both the 
...
RQ1_1 <- glmer(
  any_replay ~
    first_clovers_dummy_2*scale(pre_MA_total_score) +
    first_clovers_dummy_3*scale(pre_MA_total_score) +
    first_error_any +
    scale(pre_total_math_score) +
